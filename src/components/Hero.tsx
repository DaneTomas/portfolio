...
export default function Hero() {
  ...
  const socialLinks = [
    ...
    { icon: <FiLinkedin size={20} />, url: 'https://www.https://www.linkedin.com/in/dane-tomas-6933373a1/', label: 'LinkedIn' },
            ...
            >
              ...
              <motion.div variants={taglineAnimation} initial="hidden" animate="visible" className="relative">
                <motion.p className="text-lg md:text-xl text-gray-600 dark:text-gray-300 max-w-lg relative z-10 pb-1">
                  Architecting end-to-end AI ecosystems with OpenAI SDK, LangChain orchestration, Next.js front-ends, Python backends, and n8n automation.
                </motion.p>
                <motion.div
            ...
            >
              ...
              <div className="relative z-10 w-72 h-72 sm:w-80 sm:h-80 rounded-2xl overflow-visible flex items-center justify-center">
                ...
                <motion.div
                  ...
                  className="relative rounded-3xl  bg-gradient-to-r from-blue-500 to-purple-600 shadow-2xl"
                >
