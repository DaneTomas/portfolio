...
const skillCategories = [
  ...
  },
  {
    ...
    skills: [
      { name: 'REST APIs', icon: <SiNodedotjs />, proficiency: 91 },
      { name: 'Microservices Architecture', icon: <SiExpress />, proficiency: 91 },
      { name: 'Distributed Systems', icon: <SiPython />, proficiency: 95 },
      { name: 'gRPC', icon: <SiDjango />, proficiency: 89 },
      { name: 'JWT', icon: <FiServer className="text-sm" />, proficiency: 90 },
      { name: 'Scalable System Design', icon: <SiGraphql />, proficiency: 89 }
    ]
  },
  {
    id: 3,
    ...
    skills: [
      { name: 'Amazon Web Services', icon: <SiVercel />, proficiency: 100 },
      { name: 'Docker', icon: <SiDocker />, proficiency: 85 },
      { name: 'CI/CD', icon: <FiTool className="text-sm" />, proficiency: 90 },
      { name: 'Kubernetes', icon: <SiAmazon />, proficiency: 90 },
      { name: 'Terraform', icon: <SiNetlify />, proficiency: 90 }
    ]
  },
  {
    id: 4,
    ...
    skills: [
      ...
      { name: 'Bitbucket', icon: <SiBitbucket />, proficiency: 87 }
    ]
  },
  {
    id: 6,
    title: 'Tools, Testing & Leadership',
    ...
    skills: [
      { name: 'Linux', icon: <SiJavascript />, proficiency: 90 },
      { name: 'Confluence', icon: <SiTypescript />, proficiency: 85 },
      { name: 'PyTest', icon: <SiPython />, proficiency: 95 },
      { name: 'Technical Mentoring', icon: <SiNextdotjs />, proficiency: 100 },
      { name: 'Code Reviews', icon: <SiNextdotjs />, proficiency: 100 },
    ]
  },
];
