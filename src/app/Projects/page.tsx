...
const projects = [
  {
    ...
    githubUrl: 'https://github.com/dane-tomas/Marketplace-Hackathon-2025.git',
  },
  {
    id: 2,
    title: 'Blog Website',
    ...
    githubUrl: 'https://github.com/dane-tomas/Blog-website',
  },
  {
    id: 6,
    title: 'ChatBot',
    ...
    githubUrl: 'https://github.com/dane-tomas/ChatBot-using-next.js',
  },
   {
   id:7,
  ...
  },
  {
    ...
    githubUrl: 'https://github.com/dane-tomas/Electronic-E-Commerce.git',
  },
  // {
  //  id:7,
  //  title : 'Admin Dashboard',
  ...
  // },
  {
    ...
    githubUrl: 'https://github.com/dane-tomas/Todo-app.git',
  },
    ...
    <section id="projects" className="bg-white dark:bg-slate-800">
      <div className="section-container">
        ...
        <section className="mb-12 p-6 bg-gradient-to-r from-blue-50 to-purple-50 dark:from-slate-900 dark:to-slate-800 rounded-xl shadow">
          <h3 className="text-2xl font-bold mb-2 text-blue-700 dark:text-blue-300">Software Development & AI Integration</h3>
          <p className="text-gray-700 dark:text-gray-300 mb-2">
            Engineered AI-enabled software products leveraging OpenAI SDK, LangChain, HuggingFace, CrewAI, Chainlit, and Streamlit. Projects include end-to-end application development and automation solutions.
          </p>
          <ul className="list-disc pl-6 text-gray-700 dark:text-gray-300">
            <li>Conversational Application Development</li>
            <li>Analytical & Data-Driven Tools</li>
            <li>Automation Pipelines & Agents</li>
            <li>LLM Integration & System Design</li>
          </ul>
        </section>
