        ...
        >
          ...
          <div className="space-y-4 mb-8">
            <div className="flex items-start">
              ...
              <a href="mailto:danetomas1@outllok.com" className="text-blue-600 dark:text-blue-400 hover:underline text-sm sm:text-base">
              danetomas1@outllok.com
                </a>
              </div>
            </div>
            ...
            <div className="flex items-start">
              ...
              <div>
                ...
                <a href="tel:+1 239 849 0415" className="text-blue-600 dark:text-blue-400 hover:underline text-sm sm:text-base">
                  +1 239 849 0415
                </a>
              </div>
            </div>
